...
const BASE_ES = {
  ...
  checkMyLocation: 'Chequear mi ubicación',
  checkingLocation: 'Chequeando ubicación...',
  locationNotSupported: 'Tu dispositivo o navegador no soporta geolocalización.',
  locationPermissionError: 'No pudimos obtener tu ubicación. Revisá los permisos de geolocalización.',
  insideClimbingSector: '¡Estás dentro del sector de escalada (a menos de 1000 m)!',
  outsideClimbingSector: 'Todavía no estás dentro del sector de escalada. Estás a {distance} metros del punto de referencia.',
  ...
  connectWallet: 'Login / Sign up',
  disconnectWallet: 'Cerrar sesión',
  walletConnectedAs: 'Sesión activa: {address}',
  walletNotConnected: 'Sin sesión iniciada. Tus preferencias se guardan en este dispositivo.',
  walletConnectionError: 'No se pudo conectar la wallet.',
  ...
  getRouteDirections: 'Cómo llegar',
...
const BASE_EN = {
  ...
  locationNotSupported: 'Your device or browser does not support geolocation.',
  locationPermissionError: 'We could not get your location. Please review geolocation permissions.',
  insideClimbingSector: 'You are inside the climbing sector area (within 1000 m)!',
  outsideClimbingSector: 'You are not inside the climbing sector area yet. You are {distance} meters from the reference point.',
  ...
  walletConnectedAs: 'Signed in: {address}',
  walletNotConnected: 'No active session. Preferences are saved on this device.',
  walletConnectionError: 'Could not connect wallet.',
