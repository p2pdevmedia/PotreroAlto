...
const BASE_ES = {
  ...
  mapLegend: 'El punto naranja marca el sector general. Los subsectores y vías se dibujan de izquierda a derecha siguiendo el orden de la guía.',
...
const BASE_EN = {
  ...
  mapLegend: 'The orange marker shows the overall sector. Subsectors and routes are drawn from left to right following the guide order.',
