...
const BASE_ES = {
  ...
  walletConnectedAs: 'Conectado: {address}',
  walletNotConnected: 'Sin wallet conectada. Se guardará en este dispositivo.',
...
const BASE_EN = {
  ...
  walletConnectedAs: 'Connected: {address}',
  walletNotConnected: 'No wallet connected. Preferences are saved on this device.',
