export const POTRERO_ALTO_FALLBACK_DATA = {
  ...
  "description": "Datos de respaldo locales para subsectores y vías. Se usan cuando la API de theCrag no está disponible.",
  "subsectors": [
    {
    ...
    },
    {
      ...
      "image": "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9c/Chess_board_with_chess_set_in_opening_position_2012_PD_03.jpg/250px-Chess_board_with_chess_set_in_opening_position_2012_PD_03.jpg",
      "routes": [
        {
          "id": "tablero-1",
          "name": "Duro al Pedal!",
