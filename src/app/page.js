...
export default async function HomePage() {
  ...
  return (
    <main className="mx-auto min-h-screen w-full max-w-6xl px-4 py-10 md:px-8">
      ...
      <header id="inicio" className="relative mb-10 card overflow-hidden" style={{ aspectRatio: '7 / 3' }}>
        <div
          aria-hidden="true"
      ...
      <section id="como-llegar" className="mt-10 card">
      ...
      <section id="desarrollo-del-sector" className="mt-10 card">
